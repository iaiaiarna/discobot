...
* Open an Issue at https://github.com/iarna/discobot/issues
...
* Go to https://github.com/iarna/discobot/pulls and open a new pull request with your changes.
...
* Go to the issue tracker and [filter open issues by the `support` label](https://github.com/iarna/discobot/issues?q=is%3Aopen+is%3Aissue+label%3Asupport).
...
* Leave a message when closing saying "Cleaning up stale issue. Please reopen or ping us if and when you're ready to resume this. See https://github.com/iarna/discobot/blob/latest/CONTRIBUTING.md#clean-up-issues-and-prs for more details."
